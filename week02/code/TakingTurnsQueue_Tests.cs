...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the getnextperson function is removing sue(the last one to get in the queue) and adding her back to the queue in a loop
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: it keepes resting tim's turns but it should have kept it at 0 since he has infinite turns
